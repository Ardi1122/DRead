...
const Navbar = () => {
  return (
    <>
      {/* Versi Destop */}
      <header className="hidden md:flex justify-between items-center px-24 py-8 fixed left-0 right-0 top-0 bg-white">
        <div>
          <h1 className="text-2xl lg:text-3xl font-bold">DRead</h1>
        </div>
        <nav className="">
          <div className="flex py-2 px-6 bg-black rounded-full items-center gap-12 ">
            <Link href="/">
              <svg
      ...
      <div className="flex flex-col justify-between px-8 sm:px-12 pb-2 fixed left-0 right-0 top-0 h-screen md:hidden ">
        <div className="flex items-center justify-between bg-white py-6">
          ...
          <div className="">
            <Link
              href=""
              className="text-white font-medium py-2 px-6 bg-black rounded-full"
            >
              Sign In
            </Link>
          </div>
